...
function renderdata(data) {
  ...
  days.innerHTML = "";
  for (let i = 0; i < 5; i++) {
    let day1 = createElement(
      "div",
      "",
      `
                <p>${
                  data.forecast.forecastday[0].hour[timer + 3].time.split(
                    " "
                  )[1]
                }</p>
                <img src="${
                  data.forecast.forecastday[0].hour[timer + 3].condition.icon
                }" alt="img">
                <p>${data.forecast.forecastday[0].hour[timer + 3].temp_c}°C</p>
                <img src="./images/navigation 1.svg" alt="img">
                <p>${
                  data.forecast.forecastday[0].hour[timer + 3].wind_kph
                }km/h</p>
        `
    );
    timer += 3;
